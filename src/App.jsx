...
const NavItem = ({ to, icon: Icon, label }) => {
    ...
    return (<NavLink to={to} className="relative flex flex-col items-center justify-center py-2 px-1 rounded-xl text-zinc-500 hover:text-amber-500 transition-colors duration-200 min-w-0 flex-1 group">
            <>
                ...
                {isActive && (<motion.div layoutId="active-nav-indicator" className="absolute bottom-[-8px] h-1 w-6 bg-amber-400 rounded-full" transition={{ type: 'spring', stiffness: 350, damping: 30 }}/>)}
            </>
        </NavLink>);
};
const BottomNavBar = () => (<div className="fixed bottom-0 left-0 right-0 z-50 p-3">
